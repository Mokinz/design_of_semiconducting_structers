...
# path = "C:\\Users\\zolic_gecv9xe\\OneDrive\\Pulpit\\PSP"
# os.chdir(path)

# for i in range(1,11):
#     try:
#         NewFolder = 'Pliki' + str(i)
...
x = float(input('Podaj x: ')) #1
y = float(input('Podaj y: ')) #0.2
...
f1 = open("plik0.csv", "w+", newline="")
f2 = open("plik1.csv", "w+", newline="")
f3 = open("plik2.csv", "w+", newline="")
f4 = open("plik3.csv", "w+", newline="")
f5 = open("plik4.csv", "w+", newline="")
f6 = open("plik5.csv", "w+", newline="")
...
thewriter2 = csv.DictWriter(f2, fieldnames=fieldnames1, delimiter=",")
thewriter3 = csv.DictWriter(f3, fieldnames=fieldnames1, delimiter=",")
thewriter4 = csv.DictWriter(f4, fieldnames=fieldnames1, delimiter=",")
thewriter5 = csv.DictWriter(f5, fieldnames=fieldnames1, delimiter=",")
thewriter6 = csv.DictWriter(f6, fieldnames=fieldnames1, delimiter=",")
...
for T in range(501):
    ...
    # thewriter1.writerow({"T": T,})
    # thewriter2.writerow({"T": T,})
    # thewriter3.writerow({"T": T,})
    # thewriter4.writerow({"T": T,})
    # thewriter5.writerow({"T": T,})
    # thewriter6.writerow({"T": T,})
    ...
    while y<=1:
        ...
        #liczenie tensora odksztalcen
        exx=(alc_GaAs-alc_AlGaAsSb)/alc_AlGaAsSb #podloze-stala po interpolacji
        ...
        if y>0.6-0.00001 and y<0.6+0.000001:
